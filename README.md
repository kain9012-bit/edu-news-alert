...
7. **내부 보고서 검증 Agent**: 원문과 요약·분석·적용 검토를 대조해 근거 없는 숫자·기관·성과, 반복, 과장, 부서 지정, 장문 복사를 검사합니다. 전북교육청 자료는 요약만 검증하고, 검증에 실패해도 원문 기반 대체 요약과 링크를 보고서 마지막에 남깁니다. 타 시도 중요 항목(기본 4점 이상)은 분석 검증에서 걸려도 원문 요약과 링크를 남겨 「검토 필요」로 표시합니다.
