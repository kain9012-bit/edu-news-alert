...
- 전남광주통합특별시교육청: [`S1N1`](https://www.jngjedu.kr/news/articleList.html?sc_section_code=S1N1&view_type=sm) 본청만 수집. 통합청 사이트가 섹션 필터를 무시하고 전체기사를 반환하므로, 기사 목록의 분류 배지(본청·기관·학교)로 직접 걸러 `기관·학교·참여·전남광주교육TV·영상뉴스·책방`을 제외하고, 분석 기간이 끝날 때까지 페이지를 넘겨가며 본청 자료를 모음
