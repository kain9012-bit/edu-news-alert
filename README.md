...
4. **사실정리 Agent**: 선정된 타 시도 자료와 전북교육청 본청 자료에서 내용 요약 1~5개와 근거 사실을 추출합니다. 원문에 없는 정보나 긴 복사는 허용하지 않습니다.
...
6. **내부 보고서 검증 Agent**: 원문과 요약·분석·적용 검토를 대조해 근거 없는 숫자·기관·성과, 반복, 과장, 부서 지정, 장문 복사를 검사합니다. 전북교육청 자료는 요약만 검증하고, 통과한 항목을 보고서 마지막의 별도 구역에 원문 링크와 함께 싣습니다. 타 시도 중요 항목(기본 4점 이상)은 분석 검증에서 걸려도 원문 요약과 링크를 남겨 「검토 필요」로 표시합니다.
...
기준 JSON은 타 시도 교육동향을 `items`, 전북교육청 본청 보도자료 요약을 `ownOfficeItems`에 분리해 저장합니다. HTML·HWPX는 전국 교육동향을 먼저 보여 준 뒤 문서 마지막에 전북교육청 보도자료를 제목·날짜·중요도·내용 요약·원문 링크 형식으로 표시합니다.
